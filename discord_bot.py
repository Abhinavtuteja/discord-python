...
def search_links(keyword):
	links = []
	data = "https://www.googleapis.com/customsearch/v1?key=RoIlc8c2w&cx=017576662512468239146:omuauf_lfve&q="+keyword+'"'
...
load_dotenv()
token = "NjQ1MTk0OTM5NzQ3MDA4NTEy.XdEnqA.Aae268"
